...
{
    [Dependency(typeof(IPaymentGatewayViews), Key = "Kooboo.Commerce.Payments.PayPal.PayPalPaymentGatewayViews")]
    public class PayPalPaymentGatewayViews : IPaymentGatewayViews
    {
