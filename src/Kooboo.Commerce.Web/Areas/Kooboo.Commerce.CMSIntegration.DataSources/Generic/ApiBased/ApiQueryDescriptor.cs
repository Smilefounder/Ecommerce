...
{
    public class ApiQueryDescriptor
    {
    ...
    public class ApiQueryFilterDescriptor
    {
        ...
        {
            var filter = new FilterDefinition(Name);
    ...
    public class ApiQueryFilterParameterDescriptor
    {
        public string Name { get; set; }
